...
def main() -> int:
    ...
    write_new(root / "PROBLEM_SELECTION.md", "# Problem selection\n\nCompare required outputs, data, dominant model families, implementation risk, validation path, writing burden, team fit, external dependencies, and human-only actions.\n")
    write_new(root / "REQUIREMENT_MATRIX.md", "# Requirement matrix\n\n| Question | Operational meaning | Inputs and units | Decisions and constraints | Required outputs/files | Upstream dependency | Baseline | Validation | Paper evidence |\n|---|---|---|---|---|---|---|---|---|\n")
    write_new(root / "HUMAN_TASKS.md", "# Human tasks\n\nAI must not mark these complete without returned evidence.\n\n| ID | Task | Why human-owned | Owner | Deadline | Required evidence | Status |\n|---|---|---|---|---|---|---|\n")
