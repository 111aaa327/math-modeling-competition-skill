...
3. Read `references/workflow.md`. For CUMCM, also read `references/cumcm-template-lock.md`; for CUMCM 2026, read `references/cumcm-2026-compliance.md` as well.
...
12. When AI materially contributes, log tool/version, purpose, prompt/process, adoption, manual changes, and verification evidence. Never guess the model version.
